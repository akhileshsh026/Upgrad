...
After this, create an object named circle consisting of a key named radius. The value corresponding to the radius key is 3. Now, create another object named rectangle consisting keys named length and breadth. The values corresponding to the length and breadth keys are 1 and 2 respectively. 
 
Now, change the prototype of the circle as well as rectangle objects to the shape object.
 
At the end, print the values of the keys is2D and radius on the circle object and the values of the keys is2D, length, and breadth on the rectangle object.
